#############################################################################
# Makefile for building: gnosis-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Sep 16 11:42:52 2014
# Project:  gnosis-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile gnosis-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /home/sevith/Gnosis/Gnosis/src/leveldb/libleveldb.a /home/sevith/Gnosis/Gnosis/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: gnosis-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o Makefile gnosis-qt.pro
...
/home/sevith/Gnosis/Gnosis/src/leveldb/libleveldb.a: FORCE
	cd /home/sevith/Gnosis/Gnosis/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/sevith/Gnosis/Gnosis/build/build.h: FORCE
	cd /home/sevith/Gnosis/Gnosis; /bin/sh share/genbuild.sh /home/sevith/Gnosis/Gnosis/build/build.h
...
compiler_rcc_make_all: qrc_bitcoin.cpp qrc_style.cpp qrc_qlightstyle.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_bitcoin.cpp qrc_style.cpp qrc_qlightstyle.cpp
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/images/gns-horizontal.png \
		src/qt/res/images/about.png \
		src/qt/res/images/gns-vertical.png \
		src/qt/res/images/splash.png \
		src/qt/res/images/gnosis.png \
		...
		src/qt/res/icons/gnosis-16.png \
		src/qt/res/icons/gnosis-80.png \
...
qrc_qlightstyle.cpp: src/qt/res/themes/qlightstyle/qlightstyle.qrc \
		src/qt/res/themes/qlightstyle/style.qss
	/usr/lib/x86_64-linux-gnu/qt4/bin/rcc -name qlightstyle src/qt/res/themes/qlightstyle/qlightstyle.qrc -o qrc_qlightstyle.cpp
...
build/qrc_qlightstyle.o: qrc_qlightstyle.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/qrc_qlightstyle.o qrc_qlightstyle.cpp
