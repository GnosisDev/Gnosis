// Copyright (c) 2014 The Gnosis developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("gnosis-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("gnosis-smsg-pow"); // Make this thread recognisable
