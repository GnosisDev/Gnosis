...
const string strMessageMagic = "Gnosis Signed Message:\n";
...
{
    int64_t nSubsidy = 0;
    int64_t nMagicReward = (nHeight * 1);
    ...
    {
        nSubsidy = (100 - nMagicReward) * COIN;
    }
    else if (nHeight <= LAST_POW_BLOCK)
    {
        nSubsidy = (10001 - nMagicReward) * COIN;
    }
...
// gnosis: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Gnosis", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        */
        ...
        block.nVersion = 1;
        block.nTime    = 1409939339;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1151927 : 55887;
