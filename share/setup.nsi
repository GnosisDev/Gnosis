...
!define URL http://www.gnosis.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/gnosis.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\gnosis-qt.exe
...
OutFile gnosis-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/gnosis-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/gnosisd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\gnosis.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\gnosis-qt.exe
